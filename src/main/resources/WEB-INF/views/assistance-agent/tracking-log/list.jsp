...
<acme:list>
	...
	<acme:list-column code="assistanceAgent.trackingLog.list.label.claim" path="claim" width="20%"/>
	<acme:list-column code="assistanceAgent.trackingLog.list.label.draftMode" path="claim" width="20%"/>
	<acme:list-payload path="payload"/>
</acme:list>

<jstl:if test="${_command == 'list'}">
	<acme:button code="assistanceAgent.trackingLog.list.button.create" action="/assistanceagent/trackingLog/create"/>
</jstl:if>		
